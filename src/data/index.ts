...
export const personalProjects: PersonalProjectModel[] = [
  {
    ...
    responsilities: [
      "Multiple language [en, vi]",
      "Implement CRUD comic, chapter, comment, user, ...",
      "CI/CD with docker and digital ocean",
      "Implement UI",
      "Crawl the images from the post of facebook/another comic website and upload to s3 storage",
